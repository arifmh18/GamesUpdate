...
class BerandaController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let btnWallet = UIBarButtonItem(image: customImage, style: .plain, target: self, action:#selector(toFavorite))
        self.navigationItem.leftBarButtonItem = btnWallet
    ...
    @objc func toFavorite(){
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "favorite") as! ListFavoriteController
        self.navigationController!.pushViewController(vc, animated: true)
    }
